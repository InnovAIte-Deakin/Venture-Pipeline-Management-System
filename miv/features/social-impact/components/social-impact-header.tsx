  ...
  return (
    <header className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
      <div className="min-w-0">
        <h1 className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-2xl font-bold tracking-tight text-transparent sm:text-3xl">
      ...
      <div className="grid grid-cols-2 gap-2 sm:flex sm:shrink-0">
        ...
        <Button asChild className="min-h-10 bg-gradient-to-r from-purple-600 to-pink-600">
