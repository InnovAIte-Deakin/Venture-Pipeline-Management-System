...
export function getStatusBadge(status: string) {
  switch (status) {
    ...
    case "in_progress": return <Badge variant="secondary" className="bg-primary/10 text-primary">In Progress</Badge>
...
export function getGEDSIContainerClass(color: string): string {
  switch (color) {
    ...
    case "blue": return "bg-primary/10 dark:bg-blue-950"
...
export function getGEDSILabelClass(color: string): string {
  switch (color) {
    ...
    case "blue": return "text-primary dark:text-blue-200"
...
export function getGEDSIValueClass(color: string): string {
  switch (color) {
    ...
    case "blue": return "text-primary dark:text-primary"
