...
import { FOUNDER_TYPES, SECTORS } from "@/app/dashboard/(capital-management)/investment-rounds/libs/constants"
import { percentage } from "@/app/dashboard/(capital-management)/investment-rounds/libs/calculations"
import type { InvestmentRound, InvestmentRoundSummary, RiskLevel, RoundStatus } from "@/app/dashboard/(capital-management)/investment-rounds/libs/types"
