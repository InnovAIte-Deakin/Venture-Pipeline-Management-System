...
- Route file: `miv/app/dashboard/(g5-platform-operations)/workflows/page.tsx`
...
- `npm.cmd exec eslint -- "app/dashboard/(g5-platform-operations)/workflows/**/*.tsx" "app/dashboard/(g5-platform-operations)/workflows/**/*.ts" "app/api/(g5-platform-operations)/workflows/**/*.ts"`: passed.
