...
- Route file: `miv/app/dashboard/(analytics-insights)/advanced-reports/page.tsx`
- Next.js route group: `(analytics-insights)` is not part of the URL.
...
- `npx eslint "app/dashboard/(analytics-insights)/advanced-reports/**/*.{ts,tsx}" --format json`: no errors or warnings for this folder.
