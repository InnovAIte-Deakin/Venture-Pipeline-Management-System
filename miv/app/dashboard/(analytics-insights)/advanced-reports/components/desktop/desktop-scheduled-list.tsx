...
interface DesktopScheduledListProps {
  reports: Report[]
}

/**
 * Scheduled tab, desktop. Settings/Pause/Delete stay decorative (no
 * `onClick`) — preserved from the original, which never wired them up.
 */
export function DesktopScheduledList({ reports }: DesktopScheduledListProps) {
