...
const typeConfig: Record<CalendarEventType, { label: string; className: string; Icon: LucideIcon }> = {
  meeting: { label: "Meeting", className: "bg-primary/10 text-primary", Icon: Users },
...
const statusClass: Record<CalendarStatus, string> = { scheduled: "bg-primary/10 text-primary", in_progress: "bg-yellow-100 text-yellow-800", completed: "bg-green-100 text-green-800", cancelled: "bg-red-600 text-white" }
