...
import { DesktopSustainabilityMetrics } from "./sustainability-metrics";

export function SustainabilityDesktop(props: SustainabilityViewProps) {
  const {
    ventures,
    regenerativeData,
    digitalTwinData,
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button variant="outline" onClick={() => onSyncData()}>
