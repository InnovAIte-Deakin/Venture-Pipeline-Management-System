        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          <div className="rounded-lg border bg-white/80 p-4">
            <div className="mb-2 flex items-center space-x-2">
              ...
              <h4 className="font-semibold text-primary">UN Standards Integration</h4>
            </div>
            <p className="mb-2 text-sm text-muted-foreground">
              Washington Group Short Set implementation recommended for disability data collection
            </p>
            <div className="text-xs text-primary">IRIS+ framework integration: {metrics.length > 0 ? "Active" : "Ready"}</div>
          </div>
