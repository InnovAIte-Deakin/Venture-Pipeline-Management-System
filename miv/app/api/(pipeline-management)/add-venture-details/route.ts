...
import { CapitalActivityType, CapitalStatus, DocumentType, Prisma, PrismaClient } from '@prisma/client'
    ...
    for (const venture of ventures) {
      ...
      if (venture.stage === 'SEED' || venture.stage === 'SERIES_A' || venture.stage === 'SERIES_B' || venture.stage === 'SERIES_C') {
        capitalActivities.push(
          {
            ...
            status: CapitalStatus.COMPLETED,
        ...
        if (venture.stage === 'SERIES_B' || venture.stage === 'SERIES_C') {
          capitalActivities.push(
            {
              ventureId: venture.id,
              type: CapitalActivityType.CONVERTIBLE_NOTE,
      ...
      if (venture.sector === 'HealthTech' || venture.sector === 'EdTech' || venture.sector === 'CleanTech') {
        capitalActivities.push(
          {
            ventureId: venture.id,
            type: CapitalActivityType.GRANT,
      ...
      const documents: Prisma.DocumentCreateManyInput[] = [
        ...
        },
        {
          ...
          type: DocumentType.MARKET_RESEARCH,
      ...
      if (venture.sector === 'HealthTech') {
        documents.push({
          ...
          type: DocumentType.LEGAL_DOCUMENTS,
