...
export default function UserSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 w-64 h-screen bg-linear-to-b from-slate-900 via-slate-800 to-slate-900/95 backdrop-blur-md text-slate-100 shadow-2xl border-r border-slate-800 flex flex-col z-50 transition-all duration-300">
      {/* Logo Section */}
      ...
      <div className="p-4 border-t border-slate-700">
        <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-slate-800/50">
          <div className="w-10 h-10 bg-linear-to-br from-teal-400 to-teal-600 rounded-full flex items-center justify-center text-sm font-bold">
