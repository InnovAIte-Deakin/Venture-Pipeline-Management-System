...
import ManageWidgetsDialog from "@/components/custom-dashboards/manage-widgets-dialog"
import type { Widget } from "@/components/custom-dashboards/widget-types"
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pt-4 border-t">
            <Button variant="outline" size="sm" onClick={handleManageWidgets}>
