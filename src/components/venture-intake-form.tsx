...
const ventureIntakeSchema = z.object({
  ...
  washingtonShortSet: z
    .object({
      seeing: z
        .enum(['no_difficulty', 'some_difficulty', 'a_lot_of_difficulty', 'cannot_do_at_all'])
        .optional(),
      hearing: z
        .enum(['no_difficulty', 'some_difficulty', 'a_lot_of_difficulty', 'cannot_do_at_all'])
        .optional(),
...
const steps = [
  ...
  {
    id: 5,
    title: 'Accessibility & DLI',
    description: 'Washington Short Set + Disability Inclusion',
  },
        ...
        <Card className="p-4 hover:shadow-md transition-shadow">
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="foundingYear" className="font-medium">
                Founding Year *
              </Label>
            </div>
            <Input
      ...
      <Card className="p-6 border-dashed border-2 hover:border-blue-400 transition-colors">
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="pitchSummary" className="font-medium">
              Pitch Summary *
            </Label>
          </div>
      ...
      <Card className="p-6 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950 dark:to-emerald-950 border-green-200">
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="inclusionFocus" className="font-medium">
              Inclusion Focus *
            </Label>
          </div>
          <p className="text-sm text-gray-500 mb-3">
            How does your venture promote inclusion and address social challenges?
          </p>
          <Textarea
            id="inclusionFocus"
    ...
    <div className="space-y-8">
        ...
        <Card className="p-4 hover:shadow-md transition-shadow">
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="targetMarket" className="font-medium">
                Target Market *
              </Label>
            </div>
            <Input
      ...
      <Card className="p-6 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-950 dark:to-red-950 border-orange-200">
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-500 mb-3">
            What are the main challenges your venture faces?
          </p>
          <Textarea
            id="challenges"
            {...register('challenges')}
      ...
      <Card className="p-6 border-dashed border-2 hover:border-purple-400 transition-colors">
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="supportNeeded" className="font-medium">
              Support Needed *
            </Label>
          </div>
            ...
            {[
              ...
              <Card key={item.key} className="p-4 hover:shadow-md transition-shadow">
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={(value) =>
                      setValue(`washingtonShortSet.${item.key}` as any, value as any)
                    }
                  >
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              {
                key: 'inclusiveHiringPractices',
                label: 'Inclusive hiring practices',
                icon: CheckCircle,
              },
              {
                key: 'accessibleProductsOrServices',
                label: 'Accessible products/services',
                icon: Shield,
              },
            ].map((item) => (
              <Card key={item.key} className="p-3 hover:shadow-md transition-shadow cursor-pointer">
      ...
      <Card className="p-6 border-dashed border-2 hover:border-teal-400 transition-colors">
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="dliNotes" className="font-medium">
              Additional Notes
            </Label>
            <Badge variant="secondary" className="text-xs">
              Optional
          ...
          <p className="text-sm text-gray-500 mb-3">
            Any relevant context about accessibility or inclusion practices
          </p>
          <Textarea
            id="dliNotes"
            rows={3}
    ...
    <div className="space-y-8">
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-blue-700 dark:text-blue-200 mt-1">
              After submitting your form, our AI system will analyze your venture and suggest
              additional relevant IRIS+ metrics based on your sector, business model, and GEDSI
              goals.
            </p>
          </div>
        </div>
      ...
      <Card className="p-6 bg-gradient-to-r from-slate-50 to-gray-50 dark:from-slate-950 dark:to-gray-950 border-slate-200">
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Upload any documents that support your application and help us better understand your
            venture
          </p>
          ...
          <div className="bg-slate-100 dark:bg-slate-900 p-3 rounded-lg">
            <p className="text-xs text-slate-800 dark:text-slate-200">
              💡 <strong>Helpful documents:</strong> Pitch deck, business plan, financial
              projections, team bios, legal documents, market research, accessibility reports,
              impact reports, or any other materials that showcase your venture.
            </p>
          </div>
        </div>
      </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-4 bg-purple-50 rounded-lg">
                ...
                <p className="text-2xl font-bold text-purple-600">
                  {aiAnalysis.suggestedMetrics?.length || 0}
                </p>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              ...
              <Button>View Venture Dashboard</Button>
            </div>
          </CardContent>
        </Card>
      </div>
