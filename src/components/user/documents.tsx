      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Complete all sections to submit your venture for assessment
          </p>
        </div>
                      ...
                      <input
                        ...
                        checked={
                          formData.operationalReadiness[
                            item.key as keyof typeof formData.operationalReadiness
                          ]
                        }
                        onChange={(e) =>
                          setFormData({
                      ...
                      <input
                        ...
                        checked={
                          formData.capitalReadiness[
                            item.key as keyof typeof formData.capitalReadiness
                          ]
                        }
                        onChange={(e) =>
                          setFormData({
                      ...
                      <select
                        value={
                          formData.washingtonShortSet[
                            item.key as keyof typeof formData.washingtonShortSet
                          ]
                        }
                        onChange={(e) =>
                          setFormData({
                      ...
                      <input
                        ...
                        checked={
                          formData.disabilityInclusion[
                            item.key as keyof typeof formData.disabilityInclusion
                          ] as boolean
                        }
                        onChange={(e) =>
                          setFormData({
