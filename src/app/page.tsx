    ...
    <div className="min-h-screen bg-gradient-to-b from-grey-300 via-[#f4f4f4] to-white text-gray-900">
        ...
        <div className="max-w-6xl mx-auto px-6 my-5 lg:px-8 relative z-10 text-center pb-20">
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 mb-8 max-w-4xl mx-auto text-center">
            ...
            <p className="text-slate-300 leading-relaxed">
              MIV is here to help your impact venture grow, guiding you through preparations for
              funding, tracking your progress, and centralising your venture data to one powerful
              platform! Our services include GEDSI compliance tracking, readiness assessments, and
              streamlined capital facilitation, to help you secure the resources you need.
            </p>
          </div>
      ...
      <div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                From deal sourcing to exit management, MIV provides the tools and insights you need
        ...
        <section id="solutions" className="py-20 bg-transparent">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Whether you're a seed-stage fund or a growth equity firm, MIV adapts to your
        ...
        <section id="reviews" className="py-20 bg-transparent">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Latest Reviews</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <Card className="border-0 shadow-md">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed mb-4">
                    MIV has completely revolutionized how we manage our venture pipeline. The GEDSI
                    tracking capabilities alone have saved us countless hours and improved our
              ...
              <Card className="border-0 shadow-md">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed mb-4">
                    The AI-powered insights have helped us identify promising ventures we might have
                    otherwise overlooked. The platform is intuitive and the support team is
              ...
              <Card className="border-0 shadow-md">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed mb-4">
                    As a fund focused on sustainable development in Southeast Asia, MIV has been
                    indispensable. The capital facilitation features streamlined our investment
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <Card className="relative border-2 hover:border-purple-500 transition-colors">
                ...
                <CardContent>
                  ...
                  <Button variant="outline" className="w-full contact-sales-btn">
                    Contact Sales
                  </Button>
                </CardContent>
              </Card>
        ...
        <section id="about" className="py-20 bg-transparent">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">About MIV</h2>
                <p className="text-lg text-gray-600 mb-6">
                  MIV (Mekong Inclusive Ventures) is a comprehensive platform designed to empower
                  venture capital firms across Southeast Asia. We believe in the power of inclusive
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg mission-card">
                ...
                <p className="text-gray-600 mb-6">
                  To democratize access to venture capital and create sustainable impact through
        ...
        <section id="contact" className="py-20 bg-transparent">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Ready to transform your venture pipeline? Let's discuss how MIV can help you achieve
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Empowering inclusive ventures across Southeast <br /> Asia through innovative
                pipeline management.
              </p>
